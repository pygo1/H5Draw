...
```
 * <?php
 * class Api_HPWebService extends PhalApi_Api {
 *
 *      /**
 *       * 1.1 可在这里输入接口的服务名称
 *       * /
...
<div class="ui text container" style="max-width: none !important;">
    <div class="ui floating message">
        ...
        <p>&copy; Powered  By <a href="http://www.wuhanhope.com/" target="_blank">武汉浩谱 v<?php echo PHALAPI_VERSION; ?></a> <p>
    </div>
</div>
</body>
</html>
